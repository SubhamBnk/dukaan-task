...
export default function Home() {
  ...
  const isBlack = true; // or false, depending on your condition

const mergedStyle = {
  backgroundColor: isBlack ? 'rgba(0, 0, 0, 1)' : 'rgba(255, 255, 255, 0.1)',
};


  return (
    <div className='grid grid-cols-6 bg-white '>
  <div style={mergedStyle} className='h-100 px-2.5 py-4 text-white relative'>
