...
export default function Home() {
  ...
  const ImageComponent = () => {
    const imageStyle = {
      opacity: 0.7, // Adjust the opacity value (between 0 and 1) to decrease transparency
    };
        ...
        <div className='bg-[#353C53] h-100 px-2.5 py-4 text-white relative'>
          ...
          <div className='mt-6 gap-1'>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/home.png" alt="group" width={20} height={20} style={imageStyle} />
              <p className='text-[14px]'>Home</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/orders.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Orders</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/products.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Products</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/delivery.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Delivery</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/marketing.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Marketing</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/analytics.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Analytics</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/payments.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Payments</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/tools.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Tools</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/discounts.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Discounts</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/audience.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Audience</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/appearance.png" alt="group" width={20} height={20} />
              <p className='text-[14px]'>Appearance</p>
            </div>
            <div className='flex gap-2 px-2 py-4 rounded-md hover:bg-[#4d587b]'>
              <Image src="/plugins.png" alt="group" width={20} height={20} />
